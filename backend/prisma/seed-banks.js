...
exports.VIETQR_BANKS_DATA = void 0;
...
async function seedBanks() {
    ...
    let bankList = exports.VIETQR_BANKS_DATA;
    ...
    try {
        ...
        if (res.ok) {
            ...
            if (json && json.data && Array.isArray(json.data) && json.data.length > 0) {
                ...
                bankList = json.data.map((b, index) => ({
    ...
    for (const m of members) {
        ...
        const matched = allBanks.find((b) => b.code.toUpperCase() === raw ||
